...
\begin{document}
	...
	\abstract{
	\textbf{Motivation:}
	Pangenome graphs offer a comprehensive means of capturing genomic variability across multiple genomes. 
	However, current construction methods often introduce biases, excluding complex sequences or relying on references. 
	The PanGenome Graph Builder (PGGB) addresses these issues, yet its bash implementation hinders deployment, resource optimization, and scalability for large-scale graph construction. 
	\\
	\textbf{Results:}
	...
	Demonstrating its efficiency, we constructed pangenome graphs for 1000 human chromosome 19 haplotypes and 2146 \textit{E. coli} sequences, achieving a 2-3x speedup compared to PGGB without increasing greenhouse gas emissions. \\
	\textbf{Availability:}
...
%	\textbf{Contact:} \href{simon.heumos@qbic.uni-tuebingen.de}{simon.heumos@qbic.uni-tuebingen.de}, \href{sven.nahnsen@qbic.uni-tuebingen.de}{sven.nahnsen@qbic.uni-tuebingen.de} \\
	...
	A challenge is simultaneously representing and analyzing hundreds to thousands of genomes at a gigabase scale. One solution here is a pangenome which models a population's entire set of genomic sequences \citep{Ballouz2019}. 
